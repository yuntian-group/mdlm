...
# Export and evaluate all four arms at updates 7000 and 8000.
# Tasks 0-3 use step 7000; tasks 4-7 use step 8000.
# One paired sample per task by default; score with GPT-2-large after generation.
set -euo pipefail
...
RUN_ROOT="$CACHE_ROOT/runs/ccf_eval7k8k_l1024_t1000_$JOB_TAG/step$STEP"
