#!/bin/bash
#SBATCH --job-name=ccf-train4-10k
#SBATCH --array=0-3%2
...
# Resume full Lightning checkpoints including optimizer and scheduler state.
...
RUN_ROOT="$CACHE_ROOT/runs/four_arm_continue_s001_k128_6k_to10k_${JOB_TAG}"
