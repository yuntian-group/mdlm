...
The historical gate compared two complete samples for exact tokens, NFE and
CPU/CUDA RNG state. Standard algorithm attribution is recorded in
...
def run(pilot, argv=None):
  ...
  provenance = {
    ...
    'attribution': 'docs/experiments/README.md',
    'source_sha256': {
