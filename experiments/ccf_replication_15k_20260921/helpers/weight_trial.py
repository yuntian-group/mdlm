...
args += [f'checkpointing.resume_ckpt_path={source}','callbacks.checkpoint_every_n_steps.save_top_k=1','++callbacks.campaign._target_=weight_observer.WeightObserver','++callbacks.campaign.variant_index=3','++callbacks.campaign.expected_steps=target',f'++callbacks.campaign.namespace={namespace}']
